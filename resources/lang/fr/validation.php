...
return [
    ...
    "auth.failed"      => "Le mot de passe et l'adresse email ne corresponde pas",
    "before"           => "Le champ :attribute doit être une date antérieure au :date.",
    "before_or_equal"  => "L'age minimum est de 18 ans",
    "between"          => array(
    ...
    "file"           => "Le  :attribute sélectionné est invalide.",
